...
func DartApiInitializeDart(api unsafe.Pointer) {
...
func DartApiCloseNativePort(port int64) bool {
	result := C.GoDart_CloseNativePort(C.int64_t(port))

	return (bool)(result)
}

func DartApiGetStringList(stringListPtrAddr int64) []string {
...
// DartApiSendArchiveListing - List the archive
func DartApiSendArchiveListing(port int64, err error, result *[]onearchiver.ArchiveFileInfo) {
...
func DartApiFreeListArchiveMemory(ptrAddr int64) {
	C.ClearListArchiveMemory(C.int64_t(ptrAddr))
}

// DartApiSendIsArchiveEncrypted - Check if the archive is encrypted
func DartApiSendIsArchiveEncrypted(port int64, err error, result *onearchiver.EncryptedArchiveInfo) {
	// Parse errors
...
func DartApiFreeIsArchiveEncryptedMemory(ptrAddr int64) {
	C.ClearIsArchiveEncryptedMemory(C.int64_t(ptrAddr))
}

// DartApiSendPackFiles - Pack files
func DartApiSendPackFiles(port int64, err error, pInfo *onearchiver.ProgressInfo, packingEnded bool) {
...
func DartApiFreePackFilesMemory(ptrAddr int64) {
	C.ClearPackFilesMemory(C.int64_t(ptrAddr))
}

// DartApiSendUnpackFiles - Unpack files
func DartApiSendUnpackFiles(port int64, err error, pInfo *onearchiver.ProgressInfo, packingEnded bool) {
...
func DartApiFreeUnpackFilesMemory(ptrAddr int64) {
