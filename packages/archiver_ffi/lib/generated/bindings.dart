...
SquashArchiverLib(ffi.DynamicLibrary dynamicLibrary): _dylib = dynamicLibrary;

void InitializeDartApi(
  ffi.Pointer<ffi.Void> p0,
) {
_InitializeDartApi ??= _dylib.lookupFunction<_c_InitializeDartApi,_dart_InitializeDartApi>('InitializeDartApi');
...
_StartWork ??= _dylib.lookupFunction<_c_StartWork,_dart_StartWork>('StartWork');
  return _StartWork(
    p0,
  );
}
...
_StopWork ??= _dylib.lookupFunction<_c_StopWork,_dart_StopWork>('StopWork');
  return _StopWork(
    p0,
  );
}
