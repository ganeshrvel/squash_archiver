      ...
      if (_error.address != 0) {
        ...
        if (isNotNull(onProgress)) {
          onProgress!(
            ...
            startTime: _result.ref.startTime.toDartString(),
            totalFiles: _result.ref.totalFiles,
            currentFilename: _result.ref.currentFilename.toDartString(),
          );
        }
      }
      ...
      if (_error.address != 0) {
        ...
        if (isNotNull(onProgress)) {
          onProgress!(
            ...
            totalFiles: _result.ref.totalFiles,
            currentFilename:
                _result.ref.currentFilename.toDartString(), //toDartString
          );
        }
      }
