...
import 'package:squash_archiver/helpers/flushbar_helper.dart';
import 'package:squash_archiver/utils/utils/functs.dart';
import 'package:squash_archiver/widgets/alerts/alerts_helper.dart';
...
class Alerts {
  ...
  void _handleAlertsListUpdate() {
    for (var i = 0; i < _flushbarList.length; i++) {
      ...
      if (_flushbarList.asMap().containsKey(i)) {
